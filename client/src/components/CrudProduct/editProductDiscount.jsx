                    ...
                    <div className="bg-white py-4 px-4 shadow-xl rounded-lg my-4 mx-4">
                        <div className="flex justify-between px-4 items-center">
                            ...
                            <div className="text-lg font-semibold transform rotate-45 ">
                            {
                                ...
                                <button onClick={()=> console.log(" ")} className="focus:outline-none  bg-green-700 hover:bg-green-800 text-white font-bold py-2 px-2 rounded-full inline-flex items-center">
                                ...
                                :
                                productPreview.discount.percentage > 0 ?
                                <button onClick={() => console.log(" ")} className="focus:outline-none  bg-pink-700 hover:bg-pink-800 text-white font-bold py-2 px-2 rounded-full inline-flex items-center ">
